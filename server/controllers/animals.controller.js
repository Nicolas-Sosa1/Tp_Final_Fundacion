...
const animalsController = {
  ...
  getAdopcionAlta: async (req, res) => {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error al obtener animales en adopción alta" });
    }
  },
  getAdopcionBaja: async (req, res) => {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error al obtener animales en adopción baja" });
    }
  },
  getTransitoAlta: async (req, res) => {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error al obtener animales en tránsito alta" });
    }
  },
  getTransitoBaja: async (req, res) => {
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error al obtener animales en tránsito baja" });
    }
  },
  getOne: async (req, res) => {
    ...
    try {
      ...
      res
        .status(400)
        .json({ message: "Error al buscar el animal", error: e.message });
    }
  },
  updateOne: async (req, res) => {
    ...
    try {
      ...
      const oneUpdated = await Animals.findByIdAndUpdate(id, dataToBeUpdated, {
        new: true,
        runValidators: true,
      });
  ...
  deleteOne: async (req, res) => {
    ...
    try {
      ...
      return res
        .status(500)
        .json({ message: "Error al actualizar el estado del animal" });
    }
  },
  deletePermanent: async (req, res) => {
    ...
    try {
      ...
      return res
        .status(200)
        .json({ message: "Animal eliminado de la base de datos" });
    } catch (error) {
      return res
        .status(500)
        .json({ message: "Error al eliminar permanentemente el animal" });
    }
  },
  ...
  getAllPublic: async (req, res) => {
    try {
      // Obtener todos los animales disponibles (estadoGeneral: true)
      const lista = await Animals.find({
        estadoGeneral: true,
      })
        .populate("vacunas")
      ...
      console.error("Error al obtener todos los animales públicos:", e.message);
      return res.status(500).json({
        message: "Error al obtener animales disponibles",
        error: e.message,
      });
    }
  },
  // NUEVO: Obtener animales para adopción (público)
  getPublicAdopcion: async (req, res) => {
    try {
      const lista = await Animals.find({
        tipoIngreso: "adopcion",
        estadoGeneral: true,
      ...
      console.error("Error al obtener animales para adopción:", e.message);
      return res.status(500).json({
        message: "Error al obtener animales en adopción",
        error: e.message,
      });
    }
  },

  // NUEVO: Obtener animales para tránsito (público)
  getPublicTransito: async (req, res) => {
    try {
      const lista = await Animals.find({
        tipoIngreso: "transito",
        estadoGeneral: true,
      ...
      console.error("Error al obtener animales para tránsito:", e.message);
      return res.status(500).json({
        message: "Error al obtener animales en tránsito",
        error: e.message,
      });
    }
  },
