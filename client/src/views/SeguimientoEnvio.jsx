...
const SeguimientoEnvio = () => {
    ...
    return (
        <div className={styles.page}>
            ...
            <input className={styles.input} placeholder="Código de seguimiento" value={codigo}onChange={(e) => setCodigo(e.target.value)}/>
            <button className={styles.btn} onClick={consultar}>Consultar</button>
