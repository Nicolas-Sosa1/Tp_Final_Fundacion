        ...
        <div className={`${styles.container} ${isRegistering ? styles.active : ""}`}>
            ...
            <div className={`${styles.form_container} ${styles.sign_in}`}>
                ...
                <form onSubmit={loginProcess} className="gap-3">
                    ...
                    <button className="btn btn_navbar mb-3" type="submit">Iniciar sesión</button>

                    <p className={styles.switch_link}>
                        ¿Ya tenés cuenta?
                        <span className={styles.switch_span} onClick={() => setIsRegistering(true)}>
                            Registrate
                        </span>
                    </p>
            ...
            <div className={`${styles.form_container} ${styles.sign_up}`}>
                ...
                <form onSubmit={registerUser} >
                    ...
                    <button className="btn btn_navbar mb-3" type="submit">Registrarse</button>
                    <p className={styles.switch_link}>
                        ¿Ya tenés cuenta?
                        <span className={styles.switch_span} onClick={() => setIsRegistering(false)}>
                            Iniciar sesión
                        </span>
                    </p>
