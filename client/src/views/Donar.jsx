...
import styles from "../css/Donar.module.css";
...
const Donar = () => {
    ...
    const sendData = (e) => {
        ...
        .then(res => {
            ...
            setModalMessage("Donación creada correctamente. Serás redirigido a MercadoPago.");
            setShowModal(true);
    ...
    return (
        <div className={styles.contenedor}>
            ...
            <form className={styles.form} onSubmit={sendData}>
                <input type="number" placeholder="Ingrese un monto..." value={monto} className={styles.input} onChange={(e) => setMonto(e.target.value)}/>
