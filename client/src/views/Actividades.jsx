...
const Actividades = () => {
    ...
    const cargarSolicitudes = async () => {
        try {
            ...
            const response = await axios.get(`${baseURL}/api/solicitudes/mis-solicitudes`, config);
                            ...
                            <div className="row">
                                <div className="col-md-6 mb-4">
                                    <div className="card h-100">
                                        ...
                                        <div className="card-body">
                                            {solicitudes.adopciones && solicitudes.adopciones.length > 0 ? (
                                                        ...
                                                        return (
                                                            <div key={solicitud._id} className="list-group-item">
                                                                <div className="d-flex justify-content-between align-items-center">
                                                                    <div className="flex-grow-1">
                                                                        ...
                                                                        <small className="text-muted">
                                                                            🏠 {solicitud.viviendaTipo || 'No especificado'}
                                                                        </small>
                                                                    </div>
                                                                ...
                                                                {solicitud.motivoAdopcion && (
                                                                    <div className="mt-2">
                                                                        <small className="text-muted">
                                                                            <strong>Motivo:</strong> {solicitud.motivoAdopcion.substring(0, 100)}...
                                                                        </small>
                                                                    </div>
                                                                )}
                                                            </div>
                                                ...
                                                <div className="text-center py-3">
                                                    <p className="text-muted mb-2">No tienes solicitudes de adopción</p>
                                                    <Link to="/formulario/adopcion" className="btn btn-outline-primary btn-sm">
                                ...
                                <div className="col-md-6 mb-4">
                                    <div className="card h-100">
                                        ...
                                        <div className="card-body">
                                            {solicitudes.transitos && solicitudes.transitos.length > 0 ? (
                                                <div className="list-group">
                                                            ...
                                                            <div key={solicitud._id} className="list-group-item">
                                                                <div className="d-flex justify-content-between align-items-center">
                                                                    <div className="flex-grow-1">
                                                                        ...
                                                                        <small className="text-muted">
                                                                            ⏱️ {solicitud.tiempoDisponible || 'No especificado'}
                                                                        </small>
                                                                    </div>
                                                                    <span className={`badge ${estadoBadge.className} ms-2`}>
                                                                        {estadoBadge.text}
                                                                ...
                                                                {solicitud.experienciaConAnimales && (
                                                                    <div className="mt-2">
                                                                        <small className="text-muted">
                                                                            <strong>Experiencia:</strong> {solicitud.experienciaConAnimales.substring(0, 100)}...
                                                                        </small>
                                                                    </div>
                                                                )}
                                                            </div>
                                                ...
                                                <div className="text-center py-3">
                                                    <p className="text-muted mb-2">No tienes solicitudes de tránsito</p>
                                                    <Link to="/formulario/transito" className="btn btn-outline-warning btn-sm">
                                                        Ofrecer tránsito
                                                    </Link>
                                                </div>
                                            )}
                                    ...
                                    <div className="col-md-4 mb-3">
                                        <div className="card text-center h-100">
                                            <div className="card-body">
                                                ...
                                                <Link to="/animales" className="btn btn-outline-primary">
                                                    Ver Animales
                                                </Link>
                                            </div>
                                        </div>
