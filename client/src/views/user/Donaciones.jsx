...
import styles from "../../css/user/Donaciones.module.css";
...
const Donaciones = () => {
  ...
  const sendData = (e) => {
    ...
    axios
      ...
      .then((res) => {
        setModalMessage(
          "Estamos preparando tu donación. Te redirigiremos a Mercado Pago"
        );
        setShowModal(true);
  ...
  return (
    <div className={styles.wrapper}>
        ...
        <div className={styles.mercadoPagoBox}>
          ...
          <div>
            ...
            <form className={styles.formDonar} onSubmit={sendData}>
              ...
              <button className={styles.btnDonar}>🐾 Donar</button>
            </form>
          </div>
          {showModal && (
      ...
      <div>
        <h2 className="title_orange w-100 text-center mt-5">
          Donar a través correo Argentino
        </h2>
      ...
      <div className={styles.cardsSection}>
        <h2 className={styles.tituloSection}>
        ...
        <div className={styles.cardGrid}>
          <Card className={styles.cardBox}>
            <Card.Body>
              ...
              <Card.Text className={styles.text}>
                Tu donación asegura que nuestros perritos tengan comida
                nutritiva todos los días.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card className={styles.cardBox}>
            <Card.Body>
              <div className={styles.icon}>🩺</div>
              <Card.Text className={styles.text}>
                Con tu ayuda cubrimos vacunas, consultas y tratamientos para
                mantenerlos sanos.
              </Card.Text>
            </Card.Body>
          </Card>
          ...
          <Card className={styles.cardBox}>
            <Card.Body>
              <div className={styles.icon}>📦</div>
              <Card.Text className={styles.text}>
                Podés colaborar desde cualquier lugar enviando tu aporte por
          ...
          <Card className={styles.cardBox}>
            <Card.Body>
              <div className={styles.icon}>🐶</div>
              <Card.Text className={styles.text}>
                Gracias a tu ayuda, podemos rescatar perritos y darles un hogar
                lleno de amor.
              </Card.Text>
            </Card.Body>
          </Card>
