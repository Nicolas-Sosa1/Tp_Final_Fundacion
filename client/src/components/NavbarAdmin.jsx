  ...
  return (
      <nav className={`d-flex justify-content-between align-items-center px-5 pt-3 pb-3 mt-3 shadow-bottom ${styles.height_navbar}`}>  
        ...
        <div className="d-flex align-items-center justify-content-between w-50">
          <NavLink to="/home"className={({ isActive }) => isActive ? "text-decoration-none text-black-title font_sm navlink navlink_active": "text-decoration-none text-black-title font_sm navlink"}>Todos los perritos</NavLink>
