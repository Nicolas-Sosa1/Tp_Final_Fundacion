...
const NavbarPublic = ({logOut}) => {
  return (
        ...
        <div className="d-flex align-items-center justify-content-between w-50">
          ...
          <NavLink to="/tuActividad"className={({ isActive }) => isActive ? "text-decoration-none text-black-title font_sm navlink navlink_active": "text-decoration-none text-black-title font_sm navlink"}>Tu actividad</NavLink>
